                ...
                <b-row>
                    ...
                    >
                        <div
                            ...
                            :class="activity.item_template.key.font_size"
                        >
                            <ls-card-droppable
                                class=""
                                :item="item"
...
export default {
    ...
    methods: {
        validateByText(transferData, nativeElement, vm) {
            ...
            const values_ids = this.getKeys.length
                ? this.getKeys[0].value_ids
                : []

            if (
                values_ids.includes(draggedObject.id) &&
