export default {
    ...
    'ls-card-input-cracha': require('@/components/ui/form/CardRadioInputCracha.vue').default,
    ...
    'ls-card-image-display': require('@/components/ui/form/CardImageDisplay.vue').default,
